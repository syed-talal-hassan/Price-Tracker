...
class AmazonAPI:
    def __init__(self, search_term, filters, base_url, currency):
        ...
        self.currency = currency
        self.price_filter = f"&price={filters['min']}-{filters['max']}"
    ...
    def get_products_links(self):
        ...
        element = self.driver.find_element_by_xpath('//*[@id="q"]')
        ...
        time.sleep(2)  # wait to load page
        result_list = self.driver.find_elements_by_class_name('c1_t2i')
        links = []
        try:
    ...
    def get_title(self):
        try:
            return self.driver.find_element_by_id('module_product_title_1').text
        except Exception as e:
            print(e)
